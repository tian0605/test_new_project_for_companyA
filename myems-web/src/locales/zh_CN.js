...
export default {
    translation: {
            ...
            'Production': '产量',
            'Product': '产品',
            'Product Carbon Footprint': '碳排放管理',
            'Carbon Asset Management': '碳资产管理',
            ...
            'Annual Carbon Asset List': '年度碳资产列表',
            'Enterprise Space': '企业空间',
            'Government Quota': '政府配额',
            'Previous Year Quota': '上年结转配额',
            'Purchased Quota': '购买配额',
            'Sold Quota': '出售配额',
            'Own CCER': '自有 CCER',
            'Purchased CCER': '购买 CCER',
            'Sold CCER': '出售 CCER',
            'Purchased Green Certificate': '购买绿证',
            'Sold Green Certificate': '出售绿证',
            'Retired Green Certificate': '注销绿证',
            'Government Quota This Year': '碳配额-政府本年发放',
            'Previous Year Remaining Quota': '上年剩余配置额',
            'Purchased Quota This Year': '本年买入配额',
            'Sold Quota This Year': '本年卖出配额',
            'Free CCER Asset': '自由CCER资产',
            'Purchased CCER This Year': '本年买入CCER',
            'Sold CCER This Year': '本年卖出CCER',
            'Purchased Green Certificate This Year': '买入绿证',
            'Sold Green Certificate This Year': '卖出绿证',
            'Offset Green Certificate': '抵消绿证',
            'Allowance Quota': '碳配额',
            'Green Certificate': '绿证',
            'Annual Emissions': '年度碳排放量',
            'Monthly Carbon Emissions': '月度碳排放',
            'Remaining Allowance': '剩余可排放量',
            'Monthly Quota': '月度配额',
            'Average Distribution': '平均分配',
            'Carbon Asset Total': '碳资产总量',
            'Carbon Asset Structure': '碳资产构成',
            'Monthly Quota and Emissions': '月度配额与排放',
            'Market Supply and Demand': '市场供需信息',
            'Import Market Data': '导入市场行情',
            'Open Price': '开盘价',
            'Close Price': '收盘价',
            'High Price': '最高价',
            'Low Price': '最低价',
            ...
            Metric: '指标',
            Benchmark: '基准值',
            'Energy Evaluation': '节能评估',
            'Overall Conclusion': '综合结论',
            'Needs Improvement': '需改善',
            'Good Performance': '表现良好',
            'Non-compliant Items': '不达标项',
            'Compliant Items': '达标项',
            'Priority Focus': '优先关注',
            'Benchmark Gap': '对比',
            'Above Benchmark': '高于基准',
            'Below Benchmark': '低于基准',
            'At Benchmark': '持平基准',
            'No Benchmark Comparison': '暂无基准对比',
            'View Advice': '查看建议',
            'Hide Advice': '收起建议',
            'View Trend Details': '查看趋势明细',
            'Hide Trend Details': '收起趋势明细',
            'No Advice Available': '暂无建议',
            Advice: '建议',
            Trend: '趋势',
            'Trend Overview': '趋势概览',
            'Energy Intensity and Carbon Intensity': '能耗强度与碳排强度',
            'Actual Value': '实际值',
            'No Rule Matched': '未匹配规则',
            'Energy Intensity': '能耗强度',
            'Carbon Intensity': '碳排强度',
            Records: '条记录',
            'Per Unit Product Energy Consumption': '单位产品综合能耗',
            'Per Unit Product Carbon Dioxide Emissions': '单位产品碳排放',
            ...
            'Trading Amount': '成交额',
            'Failed Rows': '失败行数',
            'Monthly quota total mismatch': '月度配额合计必须等于年度配额总量',
            'Feature is under development': '功能正在开发中',
            'Annual Footprint List': '年度核算列表',
            'Supplier or material': '供应商或物料',
            'Supplier Name': '供应商名称',
            'Supplier Address': '供应商地址',
            'Supply Material': '供应物料',
            'Specification': '规格型号',
            'Boundary': '碳足迹边界',
            'Carbon Footprint': '碳足迹',
            'Carbon Footprint Value': '碳足迹值',
            'Carbon Footprint Unit': '碳足迹单位',
            'Contact': '联系人',
            'Phone': '联系电话',
            'Email': '联系邮箱',
            'Operation': '操作',
            ...
            'Disabled': '禁用',
            'Sort Order': '排序',
            'Add Dictionary': '新增字典项',
            'Edit Dictionary': '编辑字典项',
            'Please Select': '请选择',
            'Attachment': '附件',
            'Attachment feature is reserved': '附件功能预留',
            'Report generation is reserved': '报告生成功能预留',
            'Add Supply Material': '新增供应物料',
            'Edit Supply Material': '编辑供应物料',
            'Add Footprint': '新增核算',
            'Edit Footprint': '编辑核算',
            'Add Activity': '新增活动',
            'Edit Activity': '编辑活动',
            'Lifecycle Activities': '生命周期活动',
            'Lifecycle Carbon Footprint Report': '生命周期碳足迹统计报表',
            'Raw Material Acquisition Stage': '原材料获取阶段',
            'Manufacturing Stage': '产品制造阶段',
            'Distribution Stage': '产品分销阶段',
            'Use Stage': '产品使用阶段',
            'End of Life Stage': '产品废弃阶段',
            'Activity Name': '活动名称',
            'Activity Level': '活动水平',
            'Factor': '因子',
            'Emission Amount': '排放量',
            'Factor Source': '因子来源',
            'Carbon Footprint Contribution': '碳足迹贡献值',
            'Product Unit': '产品单位',
            'Related Supply Material': '关联供应物料',
            'Accounting Date': '核算时间',
            'Start Date': '核算开始',
            'End Date': '核算截止',
            'System Boundary': '系统边界',
            'Production Quantity': '核算期产量',
            'Functional Unit': '功能单位',
            'Total Carbon Footprint': '碳足迹总值',
            'Share': '占比',
            'Subtotal': '小计',
            'Status': '状态',
            'Details': '明细',
            ...
            'draft': '草稿',
            'void': '作废',
            'Please complete required fields': '请填写必填项',
            'Carbon footprint value must be greater than 0': '碳足迹值必须大于 0',
            'Production quantity must be greater than 0': '核算期产量必须大于 0',
            'Activity level must be greater than 0': '活动水平必须大于 0',
            'Factor must be greater than or equal to 0': '因子必须大于等于 0',
            'Please select footprint': '请选择核算单',
            'Saved successfully': '保存成功',
            'Deleted successfully': '删除成功',
            'Delete this record?': '确认删除该记录？',
            Upload: '上传',
            'Space Production': '产量能耗分析',
            'Please Select Product': '请选择产品',
            'No Product Available': '当前空间未绑定产品',
            'Product Filter Not Supported Yet': '该报表按空间级分类汇总计算，暂不支持按产品筛选，以避免产生错误结果。',
            ...
            'Per Unit Comprehensive Energy': '产品单位综合能耗',
      ...
      Please copy it to the input box below.':
            ...
            // Offline Meter Input
            'Daily Value': '日数据',
            'Monthly Total Value': '整月总值',
            'Enter Monthly Total Value': '请输入整月总值',
            'Distribute To Each Day': '分摊到每一日',
            'Load Daily Values Before Batch Input': '请先查询日数据后再批量录入',
            'Invalid Batch Value': '批量录入值无效',
            Date: '日期',
            ...
            'API.CARBON_ASSET_MONTHLY_TOTAL_MISMATCH': '月度配额合计必须等于年度配额总量',
