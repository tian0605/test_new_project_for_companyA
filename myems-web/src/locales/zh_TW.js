...
export default {
    translation: {
            ...
            'Carbon Asset Management': '碳資產管理',
            'Supply Material Maintenance': '供應物料維護',
            'Product Carbon Dictionary': '物料類別字典',
            'Supply Material Category': '供應物料類別',
            'Product Carbon Footprint Accounting': '產品碳足跡核算',
            'Annual Carbon Asset List': '年度碳資產列表',
            'Enterprise Space': '企業空間',
            'Government Quota': '政府配額',
            'Previous Year Quota': '上年結轉配額',
            'Purchased Quota': '購買配額',
            'Sold Quota': '出售配額',
            'Own CCER': '自有 CCER',
            'Purchased CCER': '購買 CCER',
            'Sold CCER': '出售 CCER',
            'Purchased Green Certificate': '購買綠證',
            'Sold Green Certificate': '出售綠證',
            'Retired Green Certificate': '註銷綠證',
            'Government Quota This Year': '碳配額-政府本年發放',
            'Previous Year Remaining Quota': '上年剩餘配置額',
            'Purchased Quota This Year': '本年買入配額',
            'Sold Quota This Year': '本年賣出配額',
            'Free CCER Asset': '自由CCER資產',
            'Purchased CCER This Year': '本年買入CCER',
            'Sold CCER This Year': '本年賣出CCER',
            'Purchased Green Certificate This Year': '買入綠證',
            'Sold Green Certificate This Year': '賣出綠證',
            'Offset Green Certificate': '抵消綠證',
            'Allowance Quota': '碳配額',
            'Green Certificate': '綠證',
            'Annual Emissions': '年度碳排放量',
            'Monthly Carbon Emissions': '月度碳排放',
            'Remaining Allowance': '剩餘可排放量',
            'Monthly Quota': '月度配額',
            'Average Distribution': '平均分配',
            'Carbon Asset Total': '碳資產總量',
            'Carbon Asset Structure': '碳資產構成',
            'Monthly Quota and Emissions': '月度配額與排放',
            'Market Supply and Demand': '市場供需資訊',
            'Import Market Data': '導入市場行情',
            'Open Price': '開盤價',
            'Close Price': '收盤價',
            'High Price': '最高價',
            'Low Price': '最低價',
            ...
            Metric: '指標',
            Benchmark: '基準值',
            'Energy Evaluation': '節能評估',
            'Overall Conclusion': '綜合結論',
            'Needs Improvement': '需改善',
            'Good Performance': '表現良好',
            'Non-compliant Items': '不達標項',
            'Compliant Items': '達標項',
            'Priority Focus': '優先關注',
            'Benchmark Gap': '對比',
            'Above Benchmark': '高於基準',
            'Below Benchmark': '低於基準',
            'At Benchmark': '持平基準',
            'No Benchmark Comparison': '暫無基準對比',
            'View Advice': '查看建議',
            'Hide Advice': '收起建議',
            'View Trend Details': '查看趨勢明細',
            'Hide Trend Details': '收起趨勢明細',
            'No Advice Available': '暫無建議',
            Advice: '建議',
            Trend: '趨勢',
            'Trend Overview': '趨勢概覽',
            'Energy Intensity and Carbon Intensity': '能耗強度與碳排強度',
            'Actual Value': '實際值',
            'No Rule Matched': '未匹配規則',
            'Energy Intensity': '能耗強度',
            'Carbon Intensity': '碳排強度',
            Records: '條記錄',
            'Per Unit Product Energy Consumption': '單位產品綜合能耗',
            'Per Unit Product Carbon Dioxide Emissions': '單位產品碳排放',
            'Ton of Standard Coal': '噸標準煤',
            'Ton of Carbon Dioxide Emissions': '噸二氧化碳排放',
            'Change Rate': '漲跌幅',
            'Trading Volume': '成交量',
            'Trading Amount': '成交額',
            'Failed Rows': '失敗行數',
            'Monthly quota total mismatch': '月度配額合計必須等於年度配額總量',
            'Feature is under development': '功能開發中',
            'Annual Footprint List': '年度核算列表',
            'Supplier or material': '供應商或物料',
            'Supplier Name': '供應商名稱',
            'Supplier Address': '供應商地址',
            'Supply Material': '供應物料',
            'Specification': '規格型號',
            'Boundary': '碳足跡邊界',
            'Carbon Footprint': '碳足跡',
            'Carbon Footprint Value': '碳足跡值',
            'Carbon Footprint Unit': '碳足跡單位',
            'Contact': '聯絡人',
            'Phone': '聯絡電話',
            'Email': '聯絡信箱',
            'Operation': '操作',
            ...
            'Disabled': '禁用',
            'Sort Order': '排序',
            'Add Dictionary': '新增字典項',
            'Edit Dictionary': '編輯字典項',
            'Please Select': '請選擇',
            'Attachment': '附件',
            'Attachment feature is reserved': '附件功能預留',
            'Report generation is reserved': '報告生成功能預留',
            'Add Supply Material': '新增供應物料',
            'Edit Supply Material': '編輯供應物料',
            'Add Footprint': '新增核算',
            'Edit Footprint': '編輯核算',
            'Add Activity': '新增活動',
            'Edit Activity': '編輯活動',
            'Lifecycle Activities': '生命週期活動',
            'Lifecycle Carbon Footprint Report': '生命週期碳足跡統計報表',
            'Raw Material Acquisition Stage': '原材料獲取階段',
            'Manufacturing Stage': '產品製造階段',
            'Distribution Stage': '產品分銷階段',
            'Use Stage': '產品使用階段',
            'End of Life Stage': '產品廢棄階段',
            'Activity Name': '活動名稱',
            'Activity Level': '活動水平',
            'Factor': '因子',
            'Emission Amount': '排放量',
            'Factor Source': '因子來源',
            'Carbon Footprint Contribution': '碳足跡貢獻值',
            'Product Unit': '產品單位',
            'Related Supply Material': '關聯供應物料',
            'Accounting Date': '核算時間',
            'Start Date': '核算開始',
            'End Date': '核算截止',
            'System Boundary': '系統邊界',
            'Production Quantity': '核算期產量',
            'Functional Unit': '功能單位',
            'Total Carbon Footprint': '碳足跡總值',
            'Share': '佔比',
            'Subtotal': '小計',
            'Status': '狀態',
            'Details': '明細',
            ...
            'draft': '草稿',
            'void': '作廢',
            'Please complete required fields': '請填寫必填項',
            'Carbon footprint value must be greater than 0': '碳足跡值必須大於 0',
            'Production quantity must be greater than 0': '核算期產量必須大於 0',
            'Activity level must be greater than 0': '活動水平必須大於 0',
            'Factor must be greater than or equal to 0': '因子必須大於等於 0',
            'Please select footprint': '請選擇核算單',
            'Saved successfully': '保存成功',
            'Deleted successfully': '刪除成功',
            'Delete this record?': '確認刪除該記錄？',
            Upload: '上傳',
            'Space Production': '產量能耗分析',
            'Please Select Product': '請選擇產品',
            'No Product Available': '當前空間未綁定產品',
            'Product Filter Not Supported Yet': '該報表按空間級分類匯總計算，暫不支持按產品篩選，以避免產生錯誤結果。',
            ...
            'Per Unit Comprehensive Energy': '產品單位綜合能耗',
            'Per Unit Product Energy Consumption': '產品單位能耗',
            'Per Unit Product Carbon Dioxide Emissions': '單位產品二氧化碳排放',
            Baseline: '基線值',
            Actual: '實際值',
    ...
    Please copy it to the input box below.':
            ...
            // Offline Meter Input
            'Daily Value': '⽇數據',
            'Monthly Total Value': '整月總值',
            'Enter Monthly Total Value': '請輸入整月總值',
            'Distribute To Each Day': '分攤到每一日',
            'Load Daily Values Before Batch Input': '請先查詢日資料後再批量錄入',
            'Invalid Batch Value': '批量錄入值無效',
            Date: '⽇期',
            ...
            'API.CARBON_ASSET_MONTHLY_TOTAL_MISMATCH': '月度配額合計必須等於年度配額總量',
