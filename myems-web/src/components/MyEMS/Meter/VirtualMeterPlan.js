...
const VirtualMeterPlan = ({ setRedirect, setRedirectUrl, t }) => {
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Virtual Meter Plan')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(VirtualMeterPlan));