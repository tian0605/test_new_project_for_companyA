...
const OfflineMeterSaving = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = e => {
    ...
    const fileName = 'OfflineMeterSaving.xlsx';
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Offline Meter Saving')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(OfflineMeterSaving));