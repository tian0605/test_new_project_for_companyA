...
const OfflineMeterPlan = ({ setRedirect, setRedirectUrl, t }) => {
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Offline Meter Plan')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(OfflineMeterPlan));