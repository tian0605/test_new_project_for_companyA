...
const MeterSaving = ({ setRedirect, setRedirectUrl, t }) => {
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Meter Saving')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(MeterSaving));