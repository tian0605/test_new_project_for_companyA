...
const MeterCarbon = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = e => {
    ...
    const fileName = 'metercarbon.xlsx';
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Meter Carbon')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(MeterCarbon));