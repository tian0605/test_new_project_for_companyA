...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_container_charge_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_container_charge_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_container_discharge_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_container_discharge_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_container_grid_buy_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_container_grid_buy_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_container_grid_sell_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_container_grid_sell_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_container_load_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_container_load_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_power_station_charge_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_power_station_charge_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_power_station_discharge_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_power_station_discharge_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_power_station_grid_buy_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_power_station_grid_buy_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_power_station_grid_sell_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_power_station_grid_sell_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_energy_storage_power_station_load_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_energy_storage_power_station_load_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_charge_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_charge_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_discharge_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_discharge_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_evcharger_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_evcharger_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_grid_buy_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_grid_buy_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_grid_sell_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_grid_sell_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_load_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_load_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_microgrid_photovoltaic_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_microgrid_photovoltaic_hourly` ;
...
CREATE INDEX `tbl_offline_meter_hourly_index_1`
 ON `myems_energy_plan_db`.`tbl_offline_meter_hourly`
 (`offline_meter_id`, `start_datetime_utc`);

-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_photovoltaic_power_station_generation_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_photovoltaic_power_station_generation_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_photovoltaic_power_station_grid_buy_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_photovoltaic_power_station_grid_buy_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_photovoltaic_power_station_grid_sell_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_photovoltaic_power_station_grid_sell_hourly` ;
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_energy_plan_db`.`tbl_photovoltaic_power_station_load_hourly`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_energy_plan_db`.`tbl_photovoltaic_power_station_load_hourly` ;
