...
VALUES
(1, '平台管理员菜单', JSON_OBJECT('template_type', 'admin', 'admin_routes', JSON_ARRAY('settings.category','settings.tariff','settings.costcenter','settings.contact','settings.gateway','settings.protocol','settings.datasource','settings.meter','settings.sensor','settings.equipment','settings.combinedequipment','settings.space','settings.tenant','settings.store','settings.shopfloor','settings.energyflowdiagram','settings.svg','settings.distributionsystem','settings.menu','settings.knowledgefile','settings.workingcalendar','users.user','users.privilege','users.menutemplate','users.apikey','users.log','settings.command','settings.controlmode','settings.iotsimcard','settings.microgrid','settings.virtualpowerplant','settings.energystoragecontainer','settings.energystoragepowerstation','settings.photovoltaicpowerstation','settings.windfarm','settings.emailserver','settings.advancedreport','settings.energyplanfile','fdd.rule','fdd.textmessage','fdd.emailmessage','fdd.webmessage','fdd.wechatmessage'), 'web_routes', JSON_ARRAY())),
(2, '企业管理员菜单', JSON_OBJECT('template_type', 'admin', 'admin_routes', JSON_ARRAY('settings.category','settings.tariff','settings.costcenter','settings.contact','settings.gateway','settings.protocol','settings.datasource','settings.meter','settings.sensor','settings.equipment','settings.combinedequipment','settings.space','settings.tenant','settings.store','settings.shopfloor','settings.energyflowdiagram','settings.svg','settings.distributionsystem','settings.workingcalendar','users.user','users.privilege','settings.command','settings.microgrid','settings.virtualpowerplant','settings.energystoragecontainer','settings.energystoragepowerstation','settings.photovoltaicpowerstation','settings.windfarm','fdd.rule','fdd.textmessage','fdd.emailmessage','fdd.webmessage','fdd.wechatmessage'), 'web_routes', JSON_ARRAY())),
(3, '企业操作员菜单', JSON_OBJECT('template_type', 'admin', 'admin_routes', JSON_ARRAY('settings.costcenter','settings.meter','settings.sensor','settings.equipment','settings.combinedequipment','settings.space','settings.tenant','settings.store','settings.shopfloor','settings.command','fdd.rule','fdd.textmessage','fdd.emailmessage','fdd.webmessage','fdd.wechatmessage'), 'web_routes', JSON_ARRAY()));
