...
VALUES
(1, '平台管理员菜单', '{"template_type":"admin","admin_routes":["settings.category","settings.tariff","settings.costcenter","settings.contact","settings.gateway","settings.protocol","settings.datasource","settings.meter","settings.sensor","settings.equipment","settings.combinedequipment","settings.space","settings.tenant","settings.store","settings.shopfloor","settings.energyflowdiagram","settings.svg","settings.distributionsystem","settings.menu","settings.knowledgefile","settings.workingcalendar","users.user","users.privilege","users.menutemplate","users.apikey","users.log","settings.command","settings.controlmode","settings.iotsimcard","settings.microgrid","settings.virtualpowerplant","settings.energystoragecontainer","settings.energystoragepowerstation","settings.photovoltaicpowerstation","settings.windfarm","settings.emailserver","settings.advancedreport","settings.energyplanfile","settings.evaluationrule","fdd.rule","fdd.textmessage","fdd.emailmessage","fdd.webmessage","fdd.wechatmessage"],"web_routes":["/carbon/asset","/space/evaluation"]}'),
(2, '企业管理员菜单', '{"template_type":"admin","admin_routes":["settings.category","settings.tariff","settings.costcenter","settings.contact","settings.gateway","settings.protocol","settings.datasource","settings.meter","settings.sensor","settings.equipment","settings.combinedequipment","settings.space","settings.tenant","settings.store","settings.shopfloor","settings.energyflowdiagram","settings.svg","settings.distributionsystem","settings.workingcalendar","users.user","users.privilege","settings.command","settings.microgrid","settings.virtualpowerplant","settings.energystoragecontainer","settings.energystoragepowerstation","settings.photovoltaicpowerstation","settings.windfarm","settings.evaluationrule","fdd.rule","fdd.textmessage","fdd.emailmessage","fdd.webmessage","fdd.wechatmessage"],"web_routes":["/carbon/asset","/space/evaluation"]}'),
(3, '企业操作员菜单', '{"template_type":"admin","admin_routes":["settings.costcenter","settings.meter","settings.sensor","settings.equipment","settings.combinedequipment","settings.space","settings.tenant","settings.store","settings.shopfloor","settings.command","fdd.rule","fdd.textmessage","fdd.emailmessage","fdd.webmessage","fdd.wechatmessage"],"web_routes":["/carbon/asset","/space/evaluation"]}');
