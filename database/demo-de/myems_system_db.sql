...
VALUES
(1, 'Kombinationsausrüstung1', '48aab70f-2e32-4518-9986-a6b7395acf58', 1, 0, 1, 1, '', 'description'),
(2, 'Kombinationsausrüstung2', 'c235e68c-e1be-4d7a-84e7-976c83ff6e44', 1, 0, 1, 1, '', 'description');
...
VALUES
(1, 'Kostenstelle', 'd97b9736-c4f9-4005-a534-6af3487303ad', NULL);
COMMIT;
...
VALUES
(1, 'Beispiel ModbusTCP Datenquellenverwaltung', 'b3ace9d4-b63b-419b-818f-0f6d1d0603a4', 1, 'modbus-tcp', '{"host":"192.168.0.1", "port":502, "interval_in_seconds":60}'),
(2, 'Beispiel ModbusRTU Datenquellenverwaltung', 'b903f0af-9115-448c-9d46-8caf5f9995f3', 1, 'modbus-rtu', '{"port": "/dev/ttyUSB0","slaveaddress": 1, "baudrate": 9600,"bytesize": 8,"parity": "N","stopbits": 1,"timeout": 0.05,"mode": "rtu"}'),
(3, 'Beispiel Bacnet/IP Datenquellenverwaltung', 'e2d5b30b-b554-4ebe-8ce7-f377ab380d19', 1, 'bacnet-ip', '{"host":"192.168.0.3", "port":47808}'),
(4, 'Beispiel S7 Datenquellenverwaltung', '9eb0d705-d02a-43f8-9c62-7e5ef508b255', 1, 's7', '{"host":"192.168.0.4", "port":102, "rack": 0, "slot": 2}'),
(5, 'Beispiel ControlLogix Datenquellenverwaltung', 'd1dc9792-7861-4dd3-9b01-07511dae16c1', 1, 'controllogix', '{"host":"192.168.0.5","port":44818,"processorslot":3}'),
(6, 'Beispiel OPU UA Datenquellenverwaltung', '56e1c642-8032-495b-af2e-18a77ca75e0f', 1, 'opc-ua', '{"url":"opc.tcp://192.168.0.6:49320/OPCUA/SimulationServer/"}'),
(7, 'Beispiel Wetter Datenquellenverwaltung', '9bff8e95-c7c9-4002-b040-08a96ae196b5', 1, 'weather', '{"base_url":"WEATHER_API_URL", "location":"beijing", "key":"APPKEY"}'),
(8, 'Beispiel MySQL Datenquellenverwaltung', '409439d0-3e0a-4ab3-865a-a5c0329925f8', 1, 'mysql', '{"host":"192.168.0.8", "port":3306, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(9, 'Beispiel SQL Server Datenquellenverwaltung', '025f0429-5088-4f2a-85a3-dff9b4523692', 1, 'sqlserver', '{"host":"192.168.0.9", "port":1433, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
...
VALUES
(1, 'Beispiel Verwaltung des Verteilungssystems', '95652719-56fa-44cc-9bef-7aa47664d4ff', 1, 'demo distribution system');
...
(7,'Druckluft','ff238e98-cd35-47c5-88a3-00617587775d','m³',1.000,1.000),
(8,'Recyceltes Wasser','7e159a34-b2e6-4fd3-ba76-897d134abe06','m³',1.000,1.000),
(9, 'Hitze','549f9cad-8db7-49d2-9473-95e37a3fc46a','KJ',1.000,1.000),
(10, 'Kälte','05aa257b-3cf6-4f19-808d-92e7dbf52b16','KJ',1.000,1.000),
(11, 'Mittleres Wasser','df6161b6-4a1b-46e7-b7c8-337b5b52d717','m³',1.000,1.000);
COMMIT;
...
VALUES
(1, 'Strom für Beleuchtung und Steckdosen', 'cade4e78-2b85-4bea-ab6e-0d6accc88d03', 1),
(2, 'Strom für Flure und Notbeleuchtung', '7a6dc086-ce08-4d66-ba75-f69af92b32f4', 1),
(3, 'Strom für die Landschaftsbeleuchtung im Freien', 'abcebbd1-b770-4e7c-ae54-8434d724522c', 1),
(4, 'Strom für Warm- und Kaltstationen', '97cdea54-04c7-4a6a-b4c2-df15874b2f49', 1),
(5, 'Strom am Ende der Klimaanlage', '84ab7262-33fb-43a1-9880-9287cc268cc0', 1),
(6, 'Aufzugsstrom', '26a5fc62-3da1-41b0-bcb1-0056e25ee121', 1),
(7, 'Strom für Wasserpumpe', 'fc6079f5-01a4-434f-9004-9382e8c3dd47', 1),
(8, 'Ventilatorleistung', 'a4bf68cd-6ae1-48dd-b281-07c95312921d', 1),
(9, 'Sonderstrom', '1990d151-02ff-4fd6-b298-2b2edee4e0ea', 1);
COMMIT;
...
(`id`, `name`, `uuid`)
VALUES
(1, 'Beispiel Energieflussdiagramm', '3ccbc9c6-9575-4212-a63a-a688d1154302');
...
VALUES
(1, 1, '10KV eingehende Leitung#1'),
(2, 1, '10KV eingehende Leitung#2'),
(3, 1, 'Mietfläche'),
(4, 1, 'Öffentliches Gebiet'),
(5, 1, 'Hotel'),
(6, 1, 'Parkplatz'),
(7, 1, 'Lebensmittel'),
(8, 1, 'Einzelhandel'),
...
(`id`, `name`, `uuid`,  `is_input_counted`, `is_output_counted`, `cost_center_id`, `svg_id`, `camera_url`, `description` )
VALUES
(1, 'Geräte1', 'bfa8b106-89a1-49ca-9b2b-a481ac41a873', 1, 0, 1, 1, '', 'description'),
(2, 'Geräte2', 'ad5798ec-d827-43d9-bf08-fc7516f9c4c8', 1, 0, 1, 1, '', 'description');
...
VALUES
(1, 'Beispiel Offline Meter', '62f473e0-1a35-41f3-9c30-8110d75d65bb', 1, 1, 0.0, 999.999, 1, 1, 'offlinemeter1');
...
(9, 'S7 Beispiel Punkt 1', 4, 'ANALOG_VALUE',  'kWh', 99999999999, 0, 1.000, 1, 0,
...
VALUES
(1, 'Beispiel Ssensor', 'ba450606-6f39-41e0-8caf-75b528635511', 'sensor description');
...
VALUES
(1, '2026TimeOfUseElectricity1-6',    '590efb36-8587-42a9-ae6f-c715d21496d6', 1, 'timeofuse', 'EUR/kWh', '2025-12-31 16:00:00', '2026-06-30 15:59:59'),
(2, '2026TimeOfUseElectricity7-9',    'f5966640-18fc-437a-9efd-cbc0c58b6373', 1, 'timeofuse', 'EUR/kWh', '2026-06-30 16:00:00', '2026-09-30 15:59:59'),
(3, '2026TimeOfUseElectricity10-12',  '21727a1b-4b27-4186-b72e-db46e6e2d980', 1, 'timeofuse', 'EUR/kWh', '2026-09-30 16:00:00', '2026-12-31 15:59:59'),
(4, '2023TimeOfUseElectricity1-6',    'fe65e443-0ec2-4a16-823e-2365885e2598', 1, 'timeofuse', 'EUR/kWh', '2022-12-31 16:00:00', '2023-06-30 15:59:59'),
(5, '2023TimeOfUseElectricity7-9',    'd1285c81-4612-4d7c-9436-ed11b4e7abe4', 1, 'timeofuse', 'EUR/kWh', '2023-06-30 16:00:00', '2023-09-30 15:59:59'),
(6, '2023TimeOfUseElectricity10-12',  'e6c275b4-47eb-4f5d-bc59-edbe45c2a407', 1, 'timeofuse', 'EUR/kWh', '2023-09-30 16:00:00', '2023-12-31 15:59:59'),
(7, '2024TimeOfUseElectricity1-6',    'ca359f72-48ad-46a7-82af-cecbe98450e8', 1, 'timeofuse', 'EUR/kWh', '2023-12-31 16:00:00', '2024-06-30 15:59:59'),
(8, '2024TimeOfUseElectricity7-9',    '9fdda603-0f8f-4452-ad59-c5df54bc35f4', 1, 'timeofuse', 'EUR/kWh', '2024-06-30 16:00:00', '2024-09-30 15:59:59'),
(9, '2024TimeOfUseElectricity10-12',  'fb0442e7-4d44-4bfd-8b20-cad3f77a2480', 1, 'timeofuse', 'EUR/kWh', '2024-09-30 16:00:00', '2024-12-31 15:59:59'),
(10, '2025TimeOfUseElectricity1-6',   '3fa6e1f2-7d08-4f5a-bcbf-beb041d569c0', 1, 'timeofuse', 'EUR/kWh', '2024-12-31 16:00:00', '2025-06-30 15:59:59'),
(11, '2025TimeOfUseElectricity7-9',   '787240fb-1694-403e-a0a7-83d7be1cc0b8', 1, 'timeofuse', 'EUR/kWh', '2025-06-30 16:00:00', '2025-09-30 15:59:59'),
(12, '2025TimeOfUseElectricity10-12', 'a07fdf76-edcf-4124-96e7-ab733a5a4b70', 1, 'timeofuse', 'EUR/kWh', '2025-09-30 16:00:00', '2025-12-31 15:59:59'),
(13, 'Leitungswasser',  '6fcbc77e-effb-4d43-9b30-77b062435d34', 2, 'timeofuse', 'EUR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59'),
(14, 'Erdgas', '6a4c56ff-b3e1-4555-9b1c-87d05bcfa4d9', 3, 'timeofuse', 'EUR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59');
...
(2, 'Retail', '1f556579-9d5c-45ce-9bd8-f2dc1d033470', 'Einzelhandel', 'RT'),
...
(`id`, `name`, `uuid`, `description`, `simplified_code`)
VALUES
(1, 'Catering-Mieter', '83fffba1-9e22-4397-a93a-3742772c3753', 'Food and Beverage', 'FNB'),
(2, 'Gas Catering Mieter', 'ad95ed16-1c57-49a9-a85e-71e389393089', 'Food and Beverage (Gas)', 'FNBGas'),
(3, 'E-Catering-Mieter', '1dc21e83-4333-40f8-9e25-ea049becba37', 'Food and Beverage (Electrical)', 'FNBElec'),
(4, 'Mieter mit hoher Beleuchtungsstärke', '4208a60d-d8e6-4fe5-8cea-a55109e9b397', 'High Illuminance Tenant', 'HighIllu'),
(5, 'Ankermieter', 'fc4ae534-544a-4a22-b83b-9f4aa99494aa', 'Anchor Tenant', 'ANCH'),
(6, 'Normale Gewerbemieter', '6d1dca30-1cbe-463d-8a78-cdd5e0f8ac8b', 'Normal Tenant', 'Normal'),
(7, 'Andere gewerbliche Mieter', '2078e1c0-3936-4ae7-9253-08e0aa1d84b6', 'Other Retail Tenants', 'Other'),
(8, 'Büromieter auf der ganzen Etage', 'b2a580a3-edc9-4838-ae1d-7b7265860a9a', 'Whole Floor Office Tenant', 'WhFlr'),
(9, 'Nicht-Ganzgeschoss-Büromieter', '55bbcba7-d8a0-44a0-9a9f-2f085e3cb044', 'None-Whole Floor Office Tenant', 'NonWhFlr');
