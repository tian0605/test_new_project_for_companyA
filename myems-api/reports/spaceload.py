"""
Space Load Report API

This module provides REST API endpoints for generating space load reports.
It analyzes space load patterns and capacity utilization to provide
