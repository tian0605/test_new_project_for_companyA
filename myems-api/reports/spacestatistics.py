"""
Space Statistics Report API

This module provides REST API endpoints for generating space statistics reports.
It analyzes statistical data and performance metrics for spaces to provide
comprehensive insights into space performance and operational patterns.
    ...
    def on_get(req, resp):
        ...
        try:
            ...
            try:
                ...
                base_category_hourly_rows = get_dimension_hourly_rows(cursor_energy,
                                                                     product_energy_sources,
                                                                     base_start_datetime_utc,
                                                                     base_end_datetime_utc)
                reporting_category_hourly_rows = get_dimension_hourly_rows(cursor_energy,
                                                                          product_energy_sources,
                                                                          reporting_start_datetime_utc,
