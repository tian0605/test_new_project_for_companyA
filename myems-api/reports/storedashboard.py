"""
Store Dashboard Report API

This module provides REST API endpoints for generating comprehensive store dashboard reports.
It aggregates data from multiple sources including stores, energy categories, sensors,
and child spaces to provide a complete overview of store energy consumption and performance.
